...
if (strlen($body) > 49) {
    ...
    try {
        ...
        $mail->addAddress('gurali_t@mail.ru', 'Tatiana');
        $mail->addAddress('larisatro@mail.ru', 'Larisa');
        $mail->addAddress('ghitunatalia1@gmail.com', 'Natalia');
        $mail->addAddress('a.plotkin@outlook.de', 'Antonina');
